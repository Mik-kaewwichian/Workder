...
export class SocialAuthService {
    ...
    async handleGoogleOAuth(idToken: string, role?: 'user' | 'worker' | 'employer') {
        ...
        return this.findOrCreateUserAndIssueToken(
            email,
    ...
    async handleFacebookOAuth(accessToken: string, expectedUserId: string, role?: 'user' | 'worker' | 'employer') {
