...
const BANGKOK_FALLBACK: [number, number] = [13.7551, 100.5018];
...
export default function WorkerMapLeaflet({ workers, mapHeight, trackedId, userLocation }: Props) {
    ...
    useEffect(() => {
        ...
        import('leaflet').then((L) => {
            ...
            // Home marker (employer / user position)
            ...
            L.default.marker(center, { icon: homeIcon }).addTo(map)
    ...
    useEffect(() => {
        ...
        import('leaflet').then(async (L) => {
            // Fetch road route
            const pts = await fetchRoute(startPos, center);
            ...
            const updateDisplay = () => {
                ...
                const km = haversineKm(pos, center);
